      ...
      <div>
        <div style={{ width: '20em' }} className="mx-auto mt-5">
          <Form.Group controlId="areaPincode">
            <Form.Control type="number" placeholder="Pin Code" className="text-center" value={pincode} onChange={(e) => { setPincode(e.target.value) }} />
          </Form.Group>
          <center>
            <Button variant="primary" type="submit" onClick={(e) => { setLoding(true) }}>
